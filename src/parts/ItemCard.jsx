                    ...
                    <CardProduct key={itemProduct.id}>
                        <div style={{ display: 'flex' }}>
                            ...
                            <DeskripsiProduct>
                                ...
                                <h5 style={{ color: 'salmon' }}>
                                    {convertToRupiah(itemProduct.price)}
                                </h5>
                            </DeskripsiProduct>
                            <div style={styles.action}>
                                <div className="opsi"
                                    style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                    <OpsiButton type='button' onClick={() => handleCount(itemProduct.id, "minus")}>-</OpsiButton>
                                    <span>{itemProduct.count}</span>
                                    <OpsiButton type='button' onClick={() => handleCount(itemProduct.id, "plus")}>+</OpsiButton>
                                    <svg width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ cursor: 'pointer' }} onClick={() => handleDelete(itemProduct.id)} >
                        ...
                        <div>
                            <div className="subtotal" style={styles.flex}>
                                ...
                                <h4>
                                    {
                                        convertToRupiah(itemProduct.total_price)
                                    }
                                </h4>
                            </div>
                        </div>
